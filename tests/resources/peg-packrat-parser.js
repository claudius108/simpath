function PEGPACKRATparser(str){
 ...
 var _Num=r(1,0,cs_0)
 var _S=r(1,0,sl_2)
 function cs_0(){var c,x;if(pos==l)return false;c=g(pos);x=c<48?0:c<58?1:0;if(x){pos++;return true}return false}
 ...
 function sl_2(){var p=pos;if(str.charCodeAt(p)==32){pos+=1;return true}return false}
...
PEGPACKRATparser.names=['Expr','Add','Mult','Num','S'];